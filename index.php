        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/crud/login.php"><i class="fa fa-power-off"></i> Login</a>
                    </li>
                </ul>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="index.php" class="list-group-item list-group-item-action"><i class="fa fa-home"></i>
                        Dashboard</a>
                    <a href="form.php" class="list-group-item list-group-item-action"><i class="fa fa-university"></i>
                        Form</a>
                    <a href="tabel.php" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> Tabel
                        Barang</a>
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-action"><i class="fa fa-file-o"></i> Laporan
                        1</a>
                    <a href="#" class="list-group-item list-group-item-action"><i class="fa fa-files-o"></i> Laporan
                        2</a>
                </div>
            </div>
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Dalam uji kompetensi Lead Programmer, Anda diharuskan menggunakan template yang disediakan
                            ini.
                            Template ini merupakan template website responsive yang dibuat menggunakan framework
                            Bootstrap.
