...
if (isset($_POST['simpan'])) {
    $simpan = mysqli_query($conn, "INSERT INTO tbl_barang (kode_barang, nama_barang, jenis_barang, deskripsi, harga, foto_barang)
										VALUES ('$_POST[kode_barang]','$_POST[nama_barang]','$_POST[jenis_barang]','$_POST[deskripsi]','$_POST[harga]','$_POST[foto_barang]')
...
<div class="col-md-9">
<div class="card">
  <h5 class="card-header text-white bg-primary">Form Tambah Barang</h5>
  <div class="card-body">
...
<!-- <h5>Tabel Tambah Barang</h5> -->
  ...
  <div class="form-group">
    ...
    <input type="text" name="kode_barang" class="form-control" placeholder="Ketik disini">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Nama Barang</label>
    <input type="text" name="nama_barang" class="form-control" placeholder="Ketik disini">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input class="form-control"  name="foto_barang" type="file">
  </div>
